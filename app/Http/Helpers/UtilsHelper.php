...
class UtilsHelper
{
    ...
    public static function renderSidebar($data, $parentId = null, $pushData = null)
    {
        foreach ($data as $index => $item) {
            ...
            if (request()->is($menuData->link_menu)) {
                $btnActive = 'side-menu--active';
                $sideMenuOpen = 'side-menu__sub-open';
            }
            ...
            if ($item['children'] === null && ($parentId === null || in_array($item['id'], $parentId))) {
                echo  '
                <li>
                    <a href="' . url($menuData->link_menu) . '" class="side-menu ' . $btnClassSpecified . ' ' . $btnActive . '">
                ...
                if ($hasVisibleChildren) {
                    ...
                    $sideMenuOpen = '';
                    $childIds = $item['children'];
                    foreach ($childIds as $key => $getChild) {
                        $getMenuData = UtilsHelper::menuFilterById($getChild);
                        if (request()->is($getMenuData->link_menu)) {
                            $btnActive = 'side-menu--active';
                            $sideMenuOpen = 'side-menu__sub-open';
                        }
                    }
                    ...
                    echo '
                    <li>
                        <a href="javascript:;" class="side-menu ' . $btnActive . '">
                            <div class="side-menu__icon"> ' . $menuData->icon_menu . ' </div>
