  ...
  a.extend(e.prototype, {
    ...
    setupStyles: function () {
      var a = "cursor:pointer;opacity:0.2;text-decoration:none;",
        b = "font-size:" + this.settings.fontSize + "px;",
        c = ".jqEmoji{" + a + b + "}";
    ...
    renderEmojis: function () {
      for (
        var a,
          b = g(this.settings.emoji),
          c = this.settings.count,
          d = "<div class='jqEmoji-container'>",
          e = 0;
        c > e;
        e++
      )
        (a = "<span class='jqEmoji' data-index='" + e + "'>" + b + "</span>"),
          (d += a);
      (d += "</div>"), h.append(d);
    },
    ...
    handleClick: function () {
      ...
      h.on("click", ".jqEmoji", function () {
        ...
        b.colorEmojis(d),
          (b.count = d),
          j ? b.updateInput(d) : (b.appendInput(d), (j = !0)),
          a.isFunction(b.settings.onUpdate) && b.settings.onUpdate.call(b, d);
      });
    },
    ...
    appendInput: function (a) {
      var b = this.settings.inputName,
        c = "<input type='hidden' class='emoji-rating'",
        d = c + " name='" + b + "' value='" + a + "' />";
      h.append(d);
    },
    ...
    (a.fn[i] = function (b) {
      return this.each(function () {
        a.data(this, "plugin_" + i) ||
          a.data(this, "plugin_" + i, new e(this, b));
      });
    });
